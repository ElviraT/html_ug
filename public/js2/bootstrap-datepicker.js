...
(function (factory) {
    ...
    fillDow: function () {
      if (this.o.showWeekDays) {
        var dowCnt = this.o.weekStart,
          html = "<tr class='calendario'>";
        if (this.o.calendarWeeks) {
          html += '<th class="cw calendario">&#160;</th>';
        }
        while (dowCnt < this.o.weekStart + 7) {
          html += '<th class="dow calendario';
          if ($.inArray(dowCnt, this.o.daysOfWeekDisabled) !== -1)
            html += " disabled";
          html +=
            '">' + dates[this.o.language].daysShort[dowCnt++ % 7] + "</th>";
        }
        html += "</tr>";
  ...
  var defaults = ($.fn.datepicker.defaults = {
    ...
    title: "",
    templates: {
      leftArrow: "<i class='bx bx-chevron-left icon-white icon-modal'></i>",
      rightArrow: "<i class='bx bx-chevron-right icon-white icon-modal'></i>",
    },
    showWeekDays: true,
  });
  ...
  var DPGlobal = {
    ...
    headTemplate:
      ...
      "</tr>" +
      "<tr class='calendario'>" +
      '<th class="prev calendario">' +
      defaults.templates.leftArrow +
      "</th>" +
      '<th colspan="5" class="datepicker-switch calendario"></th>' +
      '<th class="next calendario">' +
    ...
    footTemplate:
      "<tfoot>" +
      "<tr>" +
      '<th colspan="7" class="today calendario"></th>' +
      "</tr>" +
      "<tr>" +
